let movies = [
  {
    ...
    des1: "The Falcon and the Winter Soldier Winter Soldier.",
  ...
  {
    name: "wanda vision",
    des1: "WandaVision is an Maximoff / Scarlet Witch and Vision.",
  ...
  {
    name: "Luca",
    des1: "Luca is a 2021 American Motion Pictures.",
...
const createSlide = () => {
  ...
  p.appendChild(document.createTextNode(movies[slideIndex].des1));
